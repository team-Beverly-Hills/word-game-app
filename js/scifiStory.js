...
function renderStory() {
  ...
  story.textContent = scifiStory;
  let stringSciFi = JSON.stringify(scifiStory);
  localStorage.setItem('renderedSciFiStory', stringSciFi);
}
renderStory();

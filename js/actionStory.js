...
The 3 ${parsedStory[3].word2}s dashed out of the bank leaving nothing behind except the bag of ${parsedStory[3].word6}s. Darting through the ${parsedStory[3].word17} streets of ${parsedStory[3].word3}, they are sure that it was a job well done.
	${parsedStory[3].word18}!!! The ${parsedStory[3].word2}s were crushed by a ${parsedStory[3].word19}. Oh no!! Not the ${parsedStory[3].word20}s!!! Who would of thought after all of this time the ${parsedStory[3].word20}s would be able to foil the ${parsedStory[3].word2}’s plans. All it took to track them down was for the ${parsedStory[3].word20}s to find the bag of ${parsedStory[3].word6}s in order to track the ${parsedStory[3].word2}s. 
